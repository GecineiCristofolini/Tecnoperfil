...
@WebServlet(name = "ExportacaoServeletUtilsPackingList", urlPatterns = { "/servlet/ExportacaoServeletUtilsPackingList" })
public class ExportacaoServeletUtilsPackingList extends HttpServlet
{
	private static final long serialVersionUID = 1L;

	private static final Log log = LogFactory.getLog(ExportacaoServeletUtilsPackingList.class);
			...
			throws ServletException, IOException
	{
		...
		{
			if (action.equalsIgnoreCase("geraRelatorioPackinglist"))
				geraRelatorioPackinglist(req, resp);
	...
	//metodo para Gerar Packing List
	@SuppressWarnings("unused")
	private void geraRelatorioPackinglist(HttpServletRequest request, HttpServletResponse response)
	{
		...
		try
		{
			...
			{
				File fileProposta = TecnoperfilRelatorioPackingList.geraPDF(numeroPedido);
