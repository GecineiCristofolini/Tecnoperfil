...
@WebServlet(name = "ExportacaoServeletUtilsInvoice", urlPatterns = { "/servlet/ExportacaoServeletUtilsInvoice" })
public class ExportacaoServeletUtilsInvoice extends HttpServlet
{
	private static final long serialVersionUID = 1L;

	private static final Log log = LogFactory.getLog(ExportacaoServeletUtilsInvoice.class);
