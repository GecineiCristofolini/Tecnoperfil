	...
	public String IncluirPedido(EntityWrapper wraperpedido)
	{
		...
		try
		{
			 ...
			 if (tipoentrega.equals("3"))
			{
				...
				redespasho = wraperpedido.findGenericValue("WPedido.TransportadoraRedespacho.a4_cod");
			...
			String mensagemnota = wraperpedido.findGenericValue("WPedido.MensagemNaNota");
			...
			for (NeoObject itensPedido : itensfusion)
			{
				...
				String tabelaprecoitem = itensPedidoWrapper.findGenericValue("TabelaDePrecoTotvs.da0_codtab");
				...
				itensped.setC6_ITEMCTA("200200000"); // conta contabil IND 
			...
			for (NeoObject itensPedidoo : itensfusiono)
			{
				...
				itenspedo.setC6_ITEMCTA("200200000"); // conta contabil IND 
