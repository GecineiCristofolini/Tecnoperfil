...
public class ListaGeralEXP implements AdapterInterface
{
	...
	public void start(Task arg0, EntityWrapper wrapper, Activity arg2)
	{
		...
		try
		{
			...
			String numeropedido = wrapper.findGenericValue("PedidoEXP.NumPed");

			List<NeoObject> listapedido = PersistEngine.getObject(
					AdapterUtils.getEntityClass("HDPListaItens"),
					new QLEqualsFilter("Deletado",numeropedido));

			for (NeoObject listadelete : listapedido)

			{
				EntityWrapper WraperDelete = new EntityWrapper(listadelete);

				String deletado = "S";

				WraperDelete.setValue("Deletado", deletado);
			...
			for (NeoObject ListaItensdoPedidoavulso : ItensdoPedidoavulso)
			{
				...
				valmercadoria = valunitario.multiply(new BigDecimal(quantidade)).setScale(2,
				...
				BigDecimal qtdembalagembigdecimal = ItensdoPedidoWraper
						.findGenericValue("ProdutoTovs.b1_qe");
				Long qtdembalagem = qtdembalagembigdecimal.longValue();
				BigDecimal tamanho = ItensdoPedidoWraper
						.findGenericValue("DadosComplementares.b5_compr");
				BigDecimal Altura = ItensdoPedidoWraper
						.findGenericValue("DadosComplementares.b5_altura");
				...
				String codigocliente = wrapper
						.findGenericValue("PedidoEXP.ClienteExportacao.ClienteTotvs.a1_zfusion");
				String Lado = "";
				String passo = "";
				String diametro = "";

				NeoObject listaitenspedido = AdapterUtils.createNewEntityInstance("HDPListaItens");
			...
			List<NeoObject> ItensdoPedidoavulsohdp = wrapper
					.findGenericValue("PedidoEXP.ProjetoHEXP.ItensExportacaoAvulso");
			...
			for (NeoObject ListaItensdoPedidoavulsohdp : ItensdoPedidoavulsohdp)
			{
				...
				BigDecimal qtdembalagembigdecimal = ItensdoPedidoWraperhdp
						.findGenericValue("ProdutoTovs.b1_qe");
				Long qtdembalagem = qtdembalagembigdecimal.longValue();
				BigDecimal tamanho = ItensdoPedidoWraperhdp
						.findGenericValue("DadosComplementares.b5_compr");
				BigDecimal Altura = ItensdoPedidoWraperhdp
						.findGenericValue("DadosComplementares.b5_altura");
				BigDecimal Largura = ItensdoPedidoWraperhdp
						.findGenericValue("DadosComplementares.b5_larg");
				String narrativatecnia = "-";
				String itemped = "";
			...
			List<NeoObject> listaProjetohdp = wrapper
					.findGenericValue("PedidoEXP.ProjetoHEXP.ItensProH");
			...
			for (NeoObject projetohdp : listaProjetohdp)
			{
				...
				for (NeoObject itensprojeto : listaitensdoprojeto)
				{
					...
					BigDecimal qtdembalagembigdecimal = itensprojetopWraper
							.findGenericValue("Embalagem");
					Long qtdembalagem = qtdembalagembigdecimal.longValue();
