...
public class TotvsIncluirPedidosIND implements AdapterInterface
{
	...
	public void start(Task arg0, EntityWrapper wraperpedido, Activity arg2)
	{
		...
		try
		{
			...
			wraperpedido.findField("WPedInd.StatPedI").setValue(
	...
	public String IncluirPedido(EntityWrapper wraperpedido)
	{
		...
		try
		{
			...
			Boolean tementregadif = wraperpedido
					.findGenericValue("WPedInd.TemEntrdifTotvs.InformeSimOuNao");
			...
			if (tementregadif)
			{
				...
				if (tipoentrega.equals("3"))
				{
					...
					redespasho = wraperpedido
							.findGenericValue("WPedInd.TransportadoraRedespacho.a4_cod");
			...
			String infmensagem = wraperpedido.findGenericValue("WPedInd.InformeMensagemNota");
			String ordemcompra = wraperpedido.findGenericValue("WPedInd.OrdComI");
			String suframa = wraperpedido
					.findGenericValue("WPedInd.ClienteTotvs.ClienteTotvs.a1_suframa");
			String LocalEntrega = wraperpedido.findGenericValue("WPedInd.LocEntreg");
			...
			String Agentecompartilhado = wraperpedido
					.findGenericValue("WPedInd.AgentCompartilhado.ACodRep");
			BigDecimal ComissaoAgenteCompartilhado = wraperpedido
					.findGenericValue("WPedInd.ComissaoCompOf");
			...
			for (NeoObject itensPedido : itensfusion)
			{
				...
				if (vendcompartilhada)
				{
					...
					itensped.setC6_COMIS1(ComissaoAgente);
			...
			{
				tipooperacaoordem.trim();
				
				
				if (tipooperacaoordem.contains("05")||tipooperacaoordem.contains("07"))
				{
					...
					String tipoliberacaoo = wraperpedido
							.findGenericValue("WPedInd.TipoDeLiberacao.Codigo");
					...
					String tipooperacaoo = wraperpedido
							.findGenericValue("WPedInd.TipoDeOperacaoOrdem.x5_chave");
